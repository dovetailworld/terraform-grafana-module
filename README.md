...
| <a name="input_allow_inbound_from_cidr_blocks"></a> [allow\_inbound\_from\_cidr\_blocks](#input\_allow\_inbound\_from\_cidr\_blocks) | A list of IP CIDR blocks allowed to access the service via the lb. | `list(any)` | <pre>[<br>  "0.0.0.0/0"<br>]</pre> | no |
